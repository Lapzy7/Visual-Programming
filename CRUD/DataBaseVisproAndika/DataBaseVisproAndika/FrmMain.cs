...
namespace DataBaseVisproAndika
{
    public partial class FrmMain : Form
    {
        ...
        private void btnUpdate_Click_1(object sender, EventArgs e)
        {
            try
            {
                if (txtID.Text != "" && txtUsername.Text != "" && txtPassword.Text != "" && txtNama.Text != "")
                {
                    query = string.Format("UPDATE tbl_pengguna SET username = '{0}', password = '{1}', nama_pengguna = '{2}', level = '{3}' WHERE id_pengguna = '{4}'",
                    txtUsername.Text, txtPassword.Text, txtNama.Text, CBLevel.Text, txtID.Text);
